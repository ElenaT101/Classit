...
import sty from "./PlasmicButton.module.css"; // plasmic-import: OFPu9JjiDm3ddD/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___69CAp)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__a20Fc)}
                role={"img"}
              />
            ),
